...
def run(days=120, warmup=300, lookahead=150, max_trades=200,
        adx_min=14, don_len=15, bos_window_m15=3, vol_mult=1.00,
        entry_mode="either", supertrend_req=True,
        start_equity=100.0, risk_pct=0.02, out_csv="logs/trade_log_4m.csv"):
...
if __name__ == "__main__":
    # 4 months (~120 days)
    run(days=120, warmup=300, lookahead=150, max_trades=200,
        adx_min=14, don_len=15, bos_window_m15=3, vol_mult=1.00,
        entry_mode="either", supertrend_req=True,
        start_equity=100.0, risk_pct=0.02, out_csv="logs/trade_log_4m.csv")
